...
public class Palindromes {
	...
	public static void main(String[] args) {
		...
		System.out.println("isPalindrome(racecar): " + p.isPalindrome("Racecar"));
		System.out.println();
		System.out.println("isPalindrome1(racecar): " + p.isPalindrome1("Racecar"));
		System.out.println();
		System.out.println("isPalindromeUsingStringBuffer(racecar): " + p.isPalindromeUsingStringBuffer("Racecar"));
		System.out.println();
		System.out.println("isPalindromeUsingStringBuilder(racecar): " + p.isPalindromeUsingStringBuilder("Racecar"));
		System.out.println();
		System.out.println("isPalindrome(bob ross): " + p.isPalindrome("bob ross"));		
	}
